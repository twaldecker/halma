...
const initialGame2p: GameState[] = [
  {color: '#FF9800', row: 12, i: 4, sel: false},
  {color: '#FF9800', row: 12, i: 5, sel: false},
  {color: '#FF9800', row: 12, i: 6, sel: false},
  {color: '#FF9800', row: 12, i: 7, sel: false},
  {color: '#FF9800', row: 12, i: 8, sel: false},
  {color: '#FF9800', row: 13, i: 0, sel: false},
  {color: '#FF9800', row: 13, i: 1, sel: false},
  {color: '#FF9800', row: 13, i: 2, sel: false},
  {color: '#FF9800', row: 13, i: 3, sel: false},
  {color: '#FF9800', row: 14, i: 0, sel: false},
  {color: '#FF9800', row: 14, i: 1, sel: false},
  {color: '#FF9800', row: 14, i: 2, sel: false},
  {color: '#FF9800', row: 15, i: 0, sel: false},
  {color: '#FF9800', row: 15, i: 1, sel: false},
  {color: '#FF9800', row: 16, i: 0, sel: false},

  {color: '#00BCD4', row: 0, i: 0, sel: false},
  {color: '#00BCD4', row: 1, i: 0, sel: false},
  {color: '#00BCD4', row: 1, i: 1, sel: false},
  {color: '#00BCD4', row: 2, i: 0, sel: false},
  {color: '#00BCD4', row: 2, i: 1, sel: false},
  {color: '#00BCD4', row: 2, i: 2, sel: false},
  {color: '#00BCD4', row: 3, i: 0, sel: false},
  {color: '#00BCD4', row: 3, i: 1, sel: false},
  {color: '#00BCD4', row: 3, i: 2, sel: false},
  {color: '#00BCD4', row: 3, i: 3, sel: false},
  {color: '#00BCD4', row: 4, i: 4, sel: false},
  {color: '#00BCD4', row: 4, i: 5, sel: false},
  {color: '#00BCD4', row: 4, i: 6, sel: false},
  {color: '#00BCD4', row: 4, i: 7, sel: false},
  {color: '#00BCD4', row: 4, i: 8, sel: false},
]

const initialGame3p: GameState[] = [
  {color: '#EF5350', row: 4, i: 12, sel: false},
  {color: '#EF5350', row: 4, i: 11, sel: false},
  {color: '#EF5350', row: 4, i: 10, sel: false},
  {color: '#EF5350', row: 4, i: 9, sel: false},
  {color: '#EF5350', row: 4, i: 8, sel: false},
  {color: '#EF5350', row: 5, i: 11, sel: false},
  {color: '#EF5350', row: 5, i: 10, sel: false},
  {color: '#EF5350', row: 5, i: 9, sel: false},
  {color: '#EF5350', row: 5, i: 8, sel: false},
  {color: '#EF5350', row: 6, i: 10, sel: false},
  {color: '#EF5350', row: 6, i: 9, sel: false},
  {color: '#EF5350', row: 6, i: 8, sel: false},
  {color: '#EF5350', row: 7, i: 9, sel: false},
  {color: '#EF5350', row: 7, i: 8, sel: false},
  {color: '#EF5350', row: 8, i: 8, sel: false},

  {color: '#9C27B0', row: 4, i: 0, sel: false},
  {color: '#9C27B0', row: 4, i: 1, sel: false},
  {color: '#9C27B0', row: 4, i: 2, sel: false},
  {color: '#9C27B0', row: 4, i: 3, sel: false},
  {color: '#9C27B0', row: 4, i: 4, sel: false},
  {color: '#9C27B0', row: 5, i: 0, sel: false},
  {color: '#9C27B0', row: 5, i: 1, sel: false},
  {color: '#9C27B0', row: 5, i: 2, sel: false},
  {color: '#9C27B0', row: 5, i: 3, sel: false},
  {color: '#9C27B0', row: 6, i: 0, sel: false},
  {color: '#9C27B0', row: 6, i: 1, sel: false},
  {color: '#9C27B0', row: 6, i: 2, sel: false},
  {color: '#9C27B0', row: 7, i: 0, sel: false},
  {color: '#9C27B0', row: 7, i: 1, sel: false},
  {color: '#9C27B0', row: 8, i: 0, sel: false},

  {color: '#8BC34A', row: 12, i: 4, sel: false},
  {color: '#8BC34A', row: 12, i: 5, sel: false},
  {color: '#8BC34A', row: 12, i: 6, sel: false},
  {color: '#8BC34A', row: 12, i: 7, sel: false},
  {color: '#8BC34A', row: 12, i: 8, sel: false},
  {color: '#8BC34A', row: 13, i: 0, sel: false},
  {color: '#8BC34A', row: 13, i: 1, sel: false},
  {color: '#8BC34A', row: 13, i: 2, sel: false},
  {color: '#8BC34A', row: 13, i: 3, sel: false},
  {color: '#8BC34A', row: 14, i: 0, sel: false},
  {color: '#8BC34A', row: 14, i: 1, sel: false},
  {color: '#8BC34A', row: 14, i: 2, sel: false},
  {color: '#8BC34A', row: 15, i: 0, sel: false},
  {color: '#8BC34A', row: 15, i: 1, sel: false},
  {color: '#8BC34A', row: 16, i: 0, sel: false},
]
...
const initialGame4p: GameState[] = [
  ...
  {color: '#FFEB3B', row: 4, i: 0, sel: false},
  {color: '#FFEB3B', row: 4, i: 1, sel: false},
  {color: '#FFEB3B', row: 4, i: 2, sel: false},
  {color: '#FFEB3B', row: 4, i: 3, sel: false},
  {color: '#FFEB3B', row: 5, i: 0, sel: false},
  {color: '#FFEB3B', row: 5, i: 1, sel: false},
  {color: '#FFEB3B', row: 5, i: 2, sel: false},
  {color: '#FFEB3B', row: 6, i: 0, sel: false},
  {color: '#FFEB3B', row: 6, i: 1, sel: false},
  {color: '#FFEB3B', row: 7, i: 0, sel: false},

  {color: '#8BC34A', row: 12, i: 0, sel: false},
  {color: '#8BC34A', row: 12, i: 1, sel: false},
  {color: '#8BC34A', row: 12, i: 2, sel: false},
  {color: '#8BC34A', row: 12, i: 3, sel: false},
  {color: '#8BC34A', row: 11, i: 0, sel: false},
  {color: '#8BC34A', row: 11, i: 1, sel: false},
  {color: '#8BC34A', row: 11, i: 2, sel: false},
  {color: '#8BC34A', row: 10, i: 0, sel: false},
  {color: '#8BC34A', row: 10, i: 1, sel: false},
  {color: '#8BC34A', row: 9, i: 0, sel: false},

  {color: '#9C27B0', row: 12, i: 9, sel: false},
  {color: '#9C27B0', row: 12, i: 10, sel: false},
  {color: '#9C27B0', row: 12, i: 11, sel: false},
  {color: '#9C27B0', row: 12, i: 12, sel: false},
  {color: '#9C27B0', row: 11, i: 9, sel: false},
  {color: '#9C27B0', row: 11, i: 10, sel: false},
  {color: '#9C27B0', row: 11, i: 11, sel: false},
  {color: '#9C27B0', row: 10, i: 9, sel: false},
  {color: '#9C27B0', row: 10, i: 10, sel: false},
  {color: '#9C27B0', row: 9, i: 9, sel: false},
]
